...
itself.
- The user will see the actions execution ahead of your interpretation, for
  example if the ORAKLE command opened a URL in the system browser, the user will
  see the browser opening the webpage first then they will hear your interpretation
  via the TTS system.
